...
public class BoundedItemModifierParser extends NodeParser<BoundedItemModifier>
    ...
    public void install(ParserLibrary library) throws ParserNotSupportedException {
        ...
        this.itemModifierParser = library.type(ItemAttributeModifier.class);
    }
    ...
    @Override
    protected Result<BoundedItemModifier> parseNode(Context context, Node node, String name, String value) throws ParserException {
        AttributeKey key = this.keyParser.parse(context, node.property(
                "attribute", "attribute-key", "attributekey", "attr", "key")).orFail();
        ItemAttributeModifier itemModifier = this.itemModifierParser.parseWithDefinition(context, node, name, value).orFail();
