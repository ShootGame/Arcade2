...
public class DirectionParser extends ElementParser<Direction>
    ...
    @Override
    protected ParserResult<Direction> parseElement(Element element, String name, String value) throws ParserException {
        ...
        try {
            ...
            if (Direction.class.isAssignableFrom(field.getType())) {
                return ParserResult.fine(element, name, value, (Direction) field.get(null));
            }
